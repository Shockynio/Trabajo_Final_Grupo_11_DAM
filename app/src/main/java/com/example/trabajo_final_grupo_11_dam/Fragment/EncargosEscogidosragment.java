    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        btnCancelar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                final Pedido selectedPedido = mAdapter.getSelectedPedido();
                ...
                if (selectedPedido != null) {
                    ...
                    builder.setPositiveButton("Sí", new DialogInterface.OnClickListener() {
                        public void onClick(DialogInterface dialog, int id) {
                            // Implementar lógica para devolver el pedido a la pool de pedidos disponibles
                            String url = "https://trabajo-final-grupo-11.azurewebsites.net/pedido/devolver/" + selectedPedido.getid_pedido();
                            JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.PUT, url, null,
                                    new Response.Listener<JSONObject>() {
                                        ...
                                        public void onResponse(JSONObject response) {
                                            try {
                                                ...
                                                if (success) {
                                                    Toast.makeText(getContext(), "Pedido devuelto a la pool de pedidos disponibles exitosamente.", Toast.LENGTH_SHORT).show();

                                                    // Eliminar el pedido seleccionado del ArrayList
                                                    mAdapter.getPedidos().remove(selectedPedido);
                                ...
                                public void onErrorResponse(VolleyError error) {
                                    Log.e("DevolverPedido", "Error: " + error.getMessage());
                                    Toast.makeText(getContext(), "Error al devolver el pedido a la pool de pedidos disponibles.", Toast.LENGTH_SHORT).show();
                                }
                            });
    ...
    private void loadPedidos() {
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.GET, url, null,
                        ...
                        try {
                            ...
                            if (success) {
                                ...
                                if (pedidosArray.length() == 0) {
                                    // No pedidos found, show a message to the user
                                    Toast.makeText(getContext(), "No tienes pedidos asignados en este momento.", Toast.LENGTH_SHORT).show();
                                } else {
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast.makeText(getContext(), "No es posible encontrar pedidos asignados", Toast.LENGTH_SHORT).show();
            }
        });
